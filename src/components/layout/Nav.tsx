...
export function Nav() {
  return (
    <nav
      className="hud-panel flex items-center gap-4 border-0 px-4 py-3 transition-colors"
      role="navigation"
    ...
    >
      ...
      <form className="hidden md:block" action={async () => { "use server"; await signOut(); }}>
        <Button type="submit" variant="ghost" size="sm" className="uppercase tracking-wider font-medium">
          Sign out
        </Button>
      </form>
